...
A dark-themed, fully client-side expense tracker dashboard. Add income/expense entries, filter your transaction history, and see a live category-wise spending breakdown — all stored locally in your browser via `localStorage` (no server required).
